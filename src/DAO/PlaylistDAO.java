    ...
    public Playlist get(int id){
        try {
            ...
            if (con != null) {
                ...
                PreparedStatement pStm2 = con.prepareStatement("select m.idMedia, m.nome, m.cat,m.artista,m.link,m.biblioteca from Media m, Playlist_has_Media p where idPlaylist=? and idPlaylist=p.idPlaylist and p.idMedia = m.idMedia");
                pStm2.setInt(1, id);
